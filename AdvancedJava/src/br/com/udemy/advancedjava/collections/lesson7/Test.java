package br.com.udemy.advancedjava.collections.lesson7;
...
//		}
		...
		Map<Integer, String> linkedHashMap = new LinkedHashMap<>(); // в каком порядке пары (ключ, значение) были добавлены в таком порядке они и вернутся
